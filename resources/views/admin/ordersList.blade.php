                        ...
                        <div class="col-sm-6">
                            <div class="dataTables_length" id="example1_length">
                                <label>Сортировать по
                                    <select name="orderBy" aria-controls="example1" class="form-control input-sm"
                                            onchange="$('#filter_form').submit()">
                                        <option value="created_at" {{isset($_GET['orderBy']) && $_GET['orderBy'] == 'created_at'? 'selected': ''}}>
                                            Дата создания
                                        </option>
                                        <option value="id" {{isset($_GET['orderBy']) && $_GET['orderBy'] == 'id'? 'selected': ''}}>
                                            Id
                                        </option>
                            ...
                            <div id="example1_filter" class="dataTables_filter">
                                <label>Search:
                                    <input type="search" class="form-control input-sm"
                                           placeholder="" name="search" aria-controls="example1">
                                </label>
                            </div>
                        </div>
                    </div>
